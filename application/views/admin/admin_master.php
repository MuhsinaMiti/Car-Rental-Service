			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url('register-admin')?>"><i class=""></i><span class="hidden-tablet"> Register Admin</span></a></li>
						...
						<li><a href="<?php echo base_url('manage-booking')?>"><i class=""></i><span class="hidden-tablet"> Manage Booking</span></a></li>
