...
<head>
	...
	<!-- start: Favicon -->
	<link rel="shortcut icon" href="<?php echo base_url()?>assets/admin_assets/<?php echo base_url()?>assets/admin_assets/img/favicon.ico">
	<!-- end: Favicon -->
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Car</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?php echo base_url('admin-dashboard')?>"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
						<li><a href="<?php echo base_url('register-admin')?>"><i class="icon-envelope"></i><span class="hidden-tablet"> Rgister Admin</span></a></li>
						<li><a href="<?php echo base_url('add-brand')?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Brand</span></a></li>
						<li><a href="<?php echo base_url('all-brand')?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Manage Brand</span></a></li>
						<li><a href="<?php echo base_url('add-fuel')?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Fuel</span></a></li>
						<li><a href="<?php echo base_url('all-fuel')?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Manage Fuel</span></a></li>
                        <li><a href="<?php echo base_url('add-car')?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Car</span></a></li>
						<li><a href="<?php echo base_url('manage-car')?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Manage Car</span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:right;float:right">&copy; 2013 <a href="" alt="Dashboard">Dashboard</a></span>
