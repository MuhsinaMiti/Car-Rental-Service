					...
					<div class="box-content">
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" required="" name="car_name" value="" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" data-source='[]'required>
							  ...
							  <div class="controls">
								<input type="text" required="" name="price_per_day"  id="typeahead"  data-provide="typeahead" data-items="4" data-source='[]'required>
				       ...
				       <div class="controls">
                             <select name="car_location"  id="selectError3">
                        ...
                        <div class="control-group">
							  ...
							  <div class="controls">
								<input name="car_image" required="" class="input-file uniform_on" id="fileInput" type="file">
						</div>
						</div>
