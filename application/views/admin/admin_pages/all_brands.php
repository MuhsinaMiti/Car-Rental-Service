						  ...
						  <tbody>
							...
							<?php foreach($all_brand as $brand){?>
								...
								<td> 
                                    ...
                                    <a class="btn btn-info" href="<?php echo base_url("change-brand-status/$brand->brand_id/3");?>" onclick="return confirm('All car of this brand will be deleted!!')" title = "Delete">
