  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9 col-md-push-3">
        ...
        <div class="row">
<?php
      foreach ($all_active_car_by_brand as $v_car) 
    {
          ...
          <div class="col-md-4 grid_listing">
            <div class="product-listing-m gray-bg">
              ...
              <div class="product-listing-content">
                ...
                <p class="list-price">BDT <?php echo $v_car->price_per_day?></p>
             ...
             <!--   <p><?php echo $v_car->car_overview?></p> -->
                ...
                <ul class="features_list">
                  ...
                  <li><i class="fa fa-map-marker" aria-hidden="true"></i><?php echo $v_car->brand_name?></li>
                </ul>
              </div>
            </div>
          </div>
