          ...
          <div class="signup_wrap">
            <div class="col-md-6 col-sm-6">
              ...
              <form action="<?php echo base_url()?>save-booking" method="post">
                ...
                <div class="form-group">
                  <input type="number" name="mobile_number" class="form-control" placeholder="mobile" value="">
                </div>
                
                <div class="form-group">
                  <input type="text" name="car_delivery_address" class="form-control" placeholder="address to deliver the car" value="">
                </div>
                <div class="form-group">
                  <input type="text" name="days" class="form-control" placeholder="days" value="">
                </div>
