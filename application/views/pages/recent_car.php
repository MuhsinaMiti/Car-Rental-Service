       ...
       ?>
          ...
          <div class="col-list-3">
            <div class="recent-car-list">
              <div class="car-info-box"> <a href="#"><img src="<?php echo base_url().$v_car->car_image?>" class="img-responsive" alt="" width="600" height="375"></a>
                <ul>
              ...
              <div class="car-title-m">
                <h6><a href="#"><?php echo $v_car->car_name?></a></h6>
