       ...
       ?>
          ...
          <div class="col-list-3">
            <div class="recent-car-list">
              <div class="car-info-box"> <a href="<?php echo base_url()?>car-details/<?php echo $v_car->car_id; ?>"><img src="<?php echo base_url().$v_car->car_image?>" class="img-responsive" alt="" width="600" height= "300"></a>
        ...
        <div>
                 ...
                 <div class="label_icon">Not Available</div>

                  <?php }else {?>

                  
                 <div class="label_icon">Available</div>
                ...
                <ul>
                  <li><i class="fa fa-road" aria-hidden="true"></i><?php echo $v_car->brand_name?></li>
                  <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo $v_car->fuel_name?></li>
              ...
              <div class="car-title-m">
                ...
                <span class="price">Tk <?php echo $v_car->price_per_day?>/day</span> 
              </div>
