...
//$route['customer-registration'] = 'customer/validation';
...
$route['manage-booking'] = 'booking/manage_booking';
$route['change-booking-status/(.+)/(.+)'] = 'Booking/change_booking_status/$1/$2';
